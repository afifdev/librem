    ...
    <div class="content">
        <div class="ad-mem">
            ...
            <div class="total-member">
                <p>Total Teachers : 120</p>
            </div>
        </div>
        <div class="mem-new">
            <p><i class="fas fa-user-friends"></i>Teachers</p>
        </div>
        <!-- tabel -->
        <div class="tabel-mem">
                ...
                <tbody>
                    <tr>
                        ...
                        <td colspan="2" class="col">
                            <a href="ubahTeachers.html" class="edit"><i class="fas fa-edit"></i></a>
            ...
            <div class="foot">
                <div class="button">
                    <a href="{{ route('teacherRegister') }}">Tambah</a>
                    <a href="">Delete</a>
                </div>
                <div class="page">
