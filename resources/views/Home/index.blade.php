    ...
    <div class="row row-cols-1 row-cols-md-3 g-4 d-flex justify-content-between">
        ...
        <div class="col-md-4">
            <a href="pelajaran.html">
                <img class="mx-auto d-block" src="image/pelajaran.png" alt="Pelajaran" />
        ...
        <div class="col-md-4">
            <a href="fiksi.html">
                <img class="mx-auto d-block" src="image/fiksi.png" alt="Fiksi" />
        ...
        <!-- Non fiksi -->
        <div class="col-md-4">
            <a href="nonfiksi.html"><img class="mx-auto d-block" src="image/nonfiksi.png" alt="Non-Fiksi" />
        ...
        <div class="col-md-4">
            <a href="majalah.html">
                <img class="mx-auto d-block" src="image/majalah.png" alt="Majalah" />
        ...
        <!-- Kamus -->
        <div class="col-md-4">
            <a href="kamus.html"><img class="mx-auto d-block" src="image/kamus.png" alt="kamus" />
        ...
        <div class="col-md-center">
            <a href="lainnya.html">
                <img class="mx-auto d-block" src="image/lainnya.png" alt="Lainnya" />
