...
<div class="route-home-about">
    <div style="position:relative; min-height:67vh;">
        <div class="container konten custom-box">
            ...
            <hr />
            <p>Librem adalah portal perpustakaan online milik SMA Pelita Nusa yang memudahkan siswa dan guru untuk
                melihat
                daftar stok buku, daftar buku yang telah dipinjam, informasi mengenai pengembalian dan denda</p>
            <p>Dengan adanya librem, siswa ataupun pustakawan tak perlu lagi kesusahan dalam menghitung denda dari buku
                yang
        ...
        <div class="container custom-box">
            ...
            <ol>
                ...
                <li>Peminjam dapat melihat data buku yang telah dipinjam melalui website beserta tanggal pengembalian
                    dan
                    denda
                </li>
            </ol>
