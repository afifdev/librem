...
Route::patch('/admin/teacher/{teacher:id}/update', [TeacherController::class, 'update'])->name('teacher_update');
Route::delete('/admin/teacher/{teacher:id}/delete', [TeacherController::class, 'delete'])->name('teacher_delete');
